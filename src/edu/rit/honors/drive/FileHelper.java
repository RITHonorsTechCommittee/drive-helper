...
public interface FileHelper {
	 ...
	 * no children, return null
	 */
	public static ArrayList<File> getSiblings(File file);
	 ...
	 */
	public static File getTree(File file); 
	 ...
	 * else false
	 */
	public static boolean removeUser(User user, File file);
	 ...
	 */
	public static boolean hasUser(User user, File file); 
